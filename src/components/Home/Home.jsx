    ...
    return (
        <div className='home' id='home'>
            ...
            <div className='javier'>
                <h1>Javier Ignacio Rivarola</h1>
                <h2>Developer</h2>
                <div className="icons">
                    <a href='https://github.com/javotechno' style={{ textDecoration: 'none' }} target="_blank">
                    ...
                    <a href='https://www.linkedin.com/in/javier-ignacio-rivarola/' style={{ textDecoration: 'none' }} target="_blank">
